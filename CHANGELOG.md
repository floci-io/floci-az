...
- **blob, queue, table:** Set Service Properties now returns `202 Accepted` per the Azure Storage spec (blob and queue previously returned `200 OK`); the request body is still ignored
