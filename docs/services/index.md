...
| **Key Vault** | `/{account}-keyvault/` | ✅ Self-signed certificates with PFX/PEM secrets; secrets & keys CRUD, versioning, soft-delete, properties update, backup/restore, rotation, RSA/EC/oct crypto, `/rng`, Managed HSM |
